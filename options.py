        ...
        def check():
            try:
                ...
                if not z:
                    ...
                    #label and input box
                    self.label3 = Label(self, text='Welcome To CPA Library', bg='light blue', font=('Algerian', 45, 'bold'))
                    ...
                    self.label5 = Label(self, text='', bg='light blue', font=('arial', 16, 'bold')).place(x=170, y=235)
